...
public class Sudoku {
    public static void main(String[] argv) {new Sudoku().runOnce();}
    ...
    int[][] arrayTo2D(int[][][] array) {
        ...
        for (int i = 0; i < 9; i++) {
            ...
            for (int j = 0; j < 3; j++) {
                for (int k = 0; k < 3; k++) {
                    Array2D[j + rowAdd*3][k + colAdd*3] = array[i][j][k];
                }
            }
        }
        return Array2D;
    ...
    boolean checkBoxLogic(int[][] cellsOfBox) {
        ...
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 3; j++) {
                if (cellsOfBox[i][j] != 0) {
                    for (int k = 0; k < 9; k++) {
                        if (array[k] == cellsOfBox[i][j]) {
                            return false;
                        }
                    }
                    array[index] = cellsOfBox[i][j];
                    index = index + 1;
                }
            }
        }
    ...
    boolean checkLineLogic(int[] cellsOfLine) {
        ...
        for (int i = 0; i < 9; i++) {
            if (cellsOfLine[i] != 0) {
                for (int j = 0; j < 9; j++) {
                    if (array[j] == cellsOfLine[i]) {
                        return false;
                    }
                }
                array[index] = cellsOfLine[i];
                index = index + 1;
            }
        }
        return true;
    ...
    boolean isValid(int[][][] cells) {
        ...
        for (int i = 0; i < 9; i++) {
            ...
            boolean lineValid = checkLineLogic(line);
            if (!lineValid) {
                return false;
            }
        }
        ...
        for (int i = 0; i < 9; i++) {
            ...
            boolean boxValid = checkBoxLogic(box);
            if (!boxValid) {
                return false;
            }
        }
    ...
    void printHelpMenu() {
        ...
        System.out.println(".\t\tMark current place with 0");
        System.out.println("c\t\tCheck the puzzle");
        System.out.println("q\t\tQuit the program");
        System.out.println("h\t\tPrint help menu");
        System.out.println("Number\t\tMark current place with 0-9");
    }
        ...
        for (int i = 0; i < 9; i++) {
            ...
            for (int j = 0; j < 9; j++) {
                if (i == row && j == col) {
                    ...
                    System.out.print((twoDArray[i][j] == 0 ? ' ' : (char) (twoDArray[i][j] + '0')));
                    System.out.print(" ");
                }
                if (j % 3 == 2) {
                    System.out.print("│ ");
    ...
    void mark(int row, int col, int[][][] cells, char s) {
        ...
        cells[box][row % 3][col % 3] = Integer.parseInt(String.valueOf(s));
    }
